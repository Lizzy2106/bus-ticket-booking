...
public class ConfirmationActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton momo = (ImageButton) findViewById(R.id.momo_button);
        ImageButton flooz = (ImageButton) findViewById(R.id.flooz_button);

        flooz.setOnClickListener(new View.OnClickListener() {
            @Override

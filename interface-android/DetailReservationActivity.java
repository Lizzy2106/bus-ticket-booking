...
public class DetailReservationActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button reserver_button = (Button) findViewById(R.id.reserver_button);

        reserver_button.setOnClickListener(new View.OnClickListener() {
            @Override
